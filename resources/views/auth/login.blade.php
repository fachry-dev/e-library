            ...
            if (loginForm) {
                loginForm.addEventListener('submit', function(e) {
                    ...
                    if (valid) {
                        ...
                        // For demo purposes, we'll just show success for email: user@example.com, password: password123
                        if (email.value === 'admin@gmail.com' && password.value === 'admin123') {
                            // Redirect to dashboard or home page
                            alert('Login successful! Redirecting to dashboard...');
                            window.location.href = {{ route ('dashboard.index') }}; // Use the named route
                        } else {
                            // Show error message
