    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <div class="flex space-x-4">
            @if (Auth::user()->isAdmin())
                <a href="{{ route('books.edit', $book) }}" class="px-4 py-2 text-sm font-medium text-white bg-primary-600 border border-transparent rounded-md hover:bg-primary-700">Edit</a>
